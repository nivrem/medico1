...
function dataControlEncabezado($num_dev,$fecha,$link,$fecha_con,$factura,$cliente,$status)
{
	$label_num_dev=utf8_decode('Nro. de Dev:   ');//etiqueta de nmero de guia
	
	$this->SetFont('Arial','B',12);
	$this->SetXY(140,60);
   	$this->Cell(40,10,$label_num_dev.' '.$num_dev,0,0,0,0,$link);//numero de la guia o control de salida
	...
	$this->SetFont('Arial','B',10);
	$this->SetXY(25,80);
	$this->Cell(40,10,'Datos de la devolucion');//etiqueta del destino1
	$this->SetFont('Arial','',10);
	$this->SetXY(25,85);
	$this->Cell(40,10,'Status');//etiqueta del destino1
	//ETIQUETAS DE DETALLLES///
	...
	$this->SetXY(45,85);
	$this->MultiCell(120,10,utf8_decode($status));//destino se usa multi cell por los posibles saltos de linea
...
////////////////SECCION CASOS DE SERVICIO TECNICO////////////////////
function headerSt($Id_Caso,$link)
{
	//$this->Image('../images/encabezado.jpg',10,8,200);
	$this->SetFont('Arial','B',14);	
	$this->SetXY(35,15);
	$this->Cell(30,10,'Caso: ');//etiqueta nota
	$this->SetFont('Times','B',14);
	$this->SetTextColor(255,0,0);//RGB
	$this->SetXY(70,15);
	//die('esta es la guia'.$num_guia);
   	$this->Cell(10,10,$Id_Caso,0,0,0,0,$link);//numero de la guia o control de salida
